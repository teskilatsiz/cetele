<div align="center">
  <img src="./assets/images/cetele.png" alt="Çetele Logo" width="150" style="max-width: 100%; height: auto;" />
  <h1>Çetele</h1>
  <p>
    <b>Privacy is a right. Encryption is freedom. Your thoughts, encrypted and uncensorable.</b>
  </p>
  ...
  <!-- Downloads -->
  <p>
    <a href="https://apps.apple.com/ph/app/%C3%A7etele-%C5%9Fifreli-notlar/id6780082788">
      <img src="https://tools.applemediaservices.com/api/badges/download-on-the-app-store/black/en-us?size=250x83&amp;releaseDate=1276560000" alt="Download on the App Store" style="width: 150px; height: auto;" />
    </a>
  </p>
</div>
...
<p align="center">
  ...
  <img src="./assets/screenshots/5.png" width="200" alt="Screenshot 5" />
  <img src="./assets/screenshots/6.png" width="200" alt="Screenshot 6" />
  <img src="./assets/screenshots/7.png" width="200" alt="Screenshot 7" />
  <img src="./assets/screenshots/9.png" width="200" alt="Screenshot 9" />
</p>
...
│   ├── components/         # Shared and platform-specific UI
│   │   └── navigation/     # Native mobile and web tab layouts
│   ├── hooks/              # React hooks
│   ├── lib/                # Nostr, encryption, export, and theme services
│   ├── locales/            # App and platform localization files
│   ├── providers/          # App-wide session state
