...
export default function NotesScreen() {
  ...
  const headerBorderStyle = useAnimatedStyle(() => ({
    borderBottomColor: `rgba(255, 255, 255, ${interpolate(
      scrollY.get(), [40, 50], [0, 0.08], Extrapolation.CLAMP
    )})`,
  ...
  return (
    <SafeAreaBox style={[styles.container, { backgroundColor: colors.background }]} edges={['top']}>
      ...
      <Animated.View pointerEvents="none" style={[styles.fixedHeader, headerBorderStyle, { height: 44 + insets.top, paddingTop: insets.top }]}>
        <Animated.View style={[StyleSheet.absoluteFill, headerBlurStyle]}>
          <BlurView
            intensity={80}
            tint={colors.blurTint}
            style={[StyleSheet.absoluteFill, styles.headerBlur, { backgroundColor: colors.header }]}
          />
        </Animated.View>
