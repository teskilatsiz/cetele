...
<body>
  ...
  <script>
    ...
    window.executeCommand = function(command, value, preventFocus) {
      ...
      var restoreFormattingFocus = Boolean(preventFocus && command === 'removeFormat');
      if (!preventFocus || restoreFormattingFocus) {
        editor.focus({ preventScroll: true });
      }
...
export const RichTextEditor = forwardRef<RichTextEditorRef, RichTextEditorProps>(
  ({ initialTitle = '', initialContent, placeholder = '', onTitleChange, onChange, onFocus, onBlur, onUploadProgress, style }, ref) => {
    ...
    #editor .math-inline msup > :nth-child(2),
    #editor .math-display msup > :nth-child(2),
    #editor .math-inline msub > :nth-child(2),
    #editor .math-display msub > :nth-child(2),
    #editor .math-inline msubsup > :nth-child(2),
    #editor .math-display msubsup > :nth-child(2),
    #editor .math-inline msubsup > :nth-child(3),
    #editor .math-display msubsup > :nth-child(3),
    #editor .math-inline munder > :nth-child(2),
    #editor .math-display munder > :nth-child(2),
    #editor .math-inline mover > :nth-child(2),
    #editor .math-display mover > :nth-child(2),
    #editor .math-inline munderover > :nth-child(2),
    #editor .math-display munderover > :nth-child(2),
    #editor .math-inline munderover > :nth-child(3),
    #editor .math-display munderover > :nth-child(3) {
        ...
        <FormatBottomSheet
          ...
          onFormat={(cmd, val) => {
            if (cmd === 'foreColor' && val) {
              ...
              setActiveTextColor(colors.text);
            }
