    ...
    <head>
      ...
      <style>
        *, *::before, *::after {
        ...
        .math-inline msup > :nth-child(2),
        .math-display msup > :nth-child(2),
        .math-inline msub > :nth-child(2),
        .math-display msub > :nth-child(2),
        .math-inline msubsup > :nth-child(2),
        .math-display msubsup > :nth-child(2),
        .math-inline msubsup > :nth-child(3),
        .math-display msubsup > :nth-child(3),
        .math-inline munder > :nth-child(2),
        .math-display munder > :nth-child(2),
        .math-inline mover > :nth-child(2),
        .math-display mover > :nth-child(2),
        .math-inline munderover > :nth-child(2),
        .math-display munderover > :nth-child(2),
        .math-inline munderover > :nth-child(3),
        .math-display munderover > :nth-child(3) {
